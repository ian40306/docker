...
| ian40306/ubuntu18.04-nvidia-x11-tf2 | cuda10.0、cudnn7、ubuntu18.04、openssh-server、python3、python3-pip、vim、wget、git、libcupti-dev、iputils-ping、curl、tensorflow-gpu2、jupyter、matplotlib、pillow、lxml、pandas、Cython、opencv-python、openpyxl、dbus-x11、firefox | ubuntu18，安裝cuda10、cudnn7、ssh遠端以及一些基本程式(ssh密碼為12345678，可直接遠端)、tensorflow2以及一些相關python函式庫、jupyter notebook(登入後須設定密碼)、使用mobaxterm可叫出畫面 |  
